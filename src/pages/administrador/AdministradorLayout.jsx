...
import { Users, LogOut, Building2, Menu, X, FilePlus, History, User, GraduationCap } from 'lucide-react';
...
export default function AdministradorLayout() {
    ...
    // Sacamos el rol del arreglo y limpiamos los guiones bajos
    const rolUsuario = user?.roles?.[0]?.replace(/_/g, ' ') || 'Sin Rol';
    
    // Armamos el nombre a mostrar (opcional, para que se vea más completo)
                ...
                <div className="p-4 border-t border-white/10">
                    <div className="flex items-center gap-3 px-3 sm:px-4 py-3 mb-2 rounded-xl bg-white/5 border border-white/10">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-[10px] sm:text-xs text-gray-400 truncate capitalize">
